...
app.controller("dashboardController", ["$scope", "DashboardService", "$filter", "MapService", "ChartService", "baseURL", function (t, e, a, n, i, o) {
    t.locationData, t.currentPage = 1, t.totalPages = 496, t.isAdmin = !1, t.filters = {}, t.showDetails = !1, t.filterModel = {
        ...
        a < 1 || a > t.totalPages || (t.currentPage = a, e.getData(a, t.filters).then(function (e) {
            t.metaData = e.data, t.totalPages = Math.ceil(t.metaData.noOfElements / 10), t.locationData = JSON.parse(t.metaData.content), t.pages = t.getPages(a, t.totalPages)
        }))
    }, t.getNumbers = function (a) {
        e.getNumbers(a, t.isAdmin).then(function (e) {
            t.dashboardNumbers = e.data, t.totalToilets = {
                myValue: 0,
                myTarget: parseInt(t.dashboardNumbers.totalToilets) || 1e3,
                myDuration: 2e3,
                myEffect: "linear"
            }, t.fourToFiveStarsRated = {
                myValue: 0,
                myTarget: parseInt(t.dashboardNumbers.fourToFiveStarsRated) || 1e3,
                myDuration: 2e3,
                myEffect: "linear"
            }, t.threeOrLessStarsRated = {
                myValue: 0,
                myTarget: parseInt(t.dashboardNumbers.threeOrLessStarsRated) || 1e3,
                myDuration: 2e3,
                myEffect: "linear"
            }, t.ulbList = JSON.parse(t.dashboardNumbers.ulbsList), t.selectedUlbIndex = t.ulbList.indexOf(a), t.selectedUlb = t.ulbList[t.selectedUlbIndex], t.locationTypes = JSON.parse(t.dashboardNumbers.locationTypes), t.filters = {ulbName: a || null}, t.filterModel.ward = a || "", t.getData(1), t.isAdmin && (t.ratingDistribution = JSON.parse(e.data.ratingDistribution), t.fiveStar = JSON.parse(t.ratingDistribution.fiveStar), t.fourStar = JSON.parse(t.ratingDistribution.fourStar), t.threeStar = JSON.parse(t.ratingDistribution.threeStar), t.twoStar = JSON.parse(t.ratingDistribution.twoStar), t.oneStar = JSON.parse(t.ratingDistribution.oneStar), t.noFeedBack = JSON.parse(t.ratingDistribution.noFeedBack), console.log(t.ratingDistribution))
        })
    }, t.ratingData = function (t) {
    }, t.getPages = function (t, e) {
        var a, n, i = [];
        t <= 6 ? (a = 1, n = 10) : t + 4 >= e ? (a = e - 9, n = e) : (a = t - 5, n = t + 4), (a < 1 || n > e) && (a = 1, n = e);
        for (var o = a; o <= n; o++)i.push(o);
        return i
    }, t.getPagination = function (t) {
        return new Array(t)
    };
    var r = new Date;
    t.today = r.setDate(r.getDate()), t.yesterday = r.setDate(r.getDate() - 1);
    var l = new Date;
    t.lastWeek = l.setDate(l.getDate() - 6);
    var s = new Date;
    t.lastMonth = s.setDate(s.getDate() - 30), t.dateRange = {
        ...
        "custom" != e && (t.filterModel.fromDate = a("date")(t.dateRange[e][0], "dd-MM-yyyy"), t.filterModel.toDate = a("date")(t.dateRange[e][1], "dd-MM-yyyy"))
        ...
        t.filters = {
            ...
            ulbName: "" != t.filterModel.ward ? t.filterModel.ward : null,
            sDate: "" != t.filterModel.fromDate ? t.filterModel.fromDate : null,
            eDate: "" != t.filterModel.toDate ? t.filterModel.toDate : null,
            download: n
        }, n ? t.downloadReport() : t.getData(1)
    }, t.downloadReport = function (e) {
        window.open(o + "download-report-of-locations/" + t.filters.minRating + "/" + t.filters.maxRating + "/" + t.filters.page + "/10/?locationType=" + t.filters.locationName + "&startDate=" + t.filters.sDate + "&endDate=" + t.filters.eDate + "&ulbName=" + t.filters.ulbName)
    }, t.clearFilters = function () {
        t.filterModel = t.filterModelCopy
    }, t.getReviews = function (a, n, i, o) {
        o || $("#reviews").modal({show: !0}), e.getReviews(a, n, i).then(function (e) {
            t.reviews = JSON.parse(e.data.content)
        })
    }, t.showToiletDetails = function (a) {
        t.toiletDetail = a, t.showDetails = !0, $("[href='#oRatings']").tab("show"), t.getReviews(a.location.id, 0, 5, !0), i.getPieChart(), t.isAdmin && e.getRatingData(t.toiletDetail.location.id).then(function (t) {
            var e = JSON.parse(t.data.content), a = [], n = [], o = 1;
            angular.forEach(e, function (t, e) {
                a.push(e);
                for (var i = {
                    name: "",
                    data: []
                }, r = JSON.parse(t), l = 1; l < 7; l++)i.data.push(r[l]), 5 == l && o < 6 && (i.name = o + " Stars", o++);
                n.push(i)
            }), i.getBarGraph(a, n)
        })
        ...
        t.isAdmin = !0, t.getNumbers(e), e || n.drawMap(t.getNumbers)
    }
    ...
    this.getData = function (a, n) {
        ...
        angular.extend(i, n);
        var o;
        return o = i.download ? "download-report-of-locations" : "get-report-of-locations", t({
            method: "GET",
            url: e + o + "/" + i.minRating + "/" + i.maxRating + "/" + a + "/" + i.pageSize,
            params: {locationType: i.locationName, startDate: i.sDate, endDate: i.eDate, ulbName: i.ulbName}
        }).then(function (t) {
            return t
        }, function (t) {
            console.log(t)
    ...
    }, this.getReviews = function (a, n, i) {
        return t({method: "GET", url: e + "get-reviews-of-location/" + a + "/" + n + "/" + i}).then(function (t) {
            return t
        }, function (t) {
            console.log(t)
        })
    ...
    this.getPieChart = function (t) {
        return Highcharts.chart("pie-chart", {
            ...
            series: [{
                name: "share",
                colorByPoint: !0,
                data: [{name: "5 Stars", y: 56.33}, {
                    name: "4 Stars",
                    y: 24.03,
                    sliced: !0,
                    selected: !0
                }, {name: "3 Stars", y: 10.38}, {name: "2 Stars", y: 4.77}, {name: "1 Stars", y: .93}]
            }],
            credits: {enabled: !1}
        })
        ...
        return {
            ...
            link: function (a, n, i, o, r) {
                function l() {
                    ...
                    var p = {};
                    r("id", a.sliderid), r("orientation", i.orientation, "horizontal"), r("selection", i.selection, "before"), r("handle", i.handle, "round"), r("tooltip", i.sliderTooltip || i.tooltip, "show"), r("tooltip_position", i.sliderTooltipPosition, "top"), r("tooltipseparator", i.tooltipseparator, ":"), r("ticks", a.ticks), r("ticks_labels", a.ticksLabels), r("ticks_snap_bounds", a.ticksSnapBounds), r("ticks_positions", a.ticksPositions), r("ticks_tooltip", a.ticksTooltip, !1), r("rangeHighlights", a.rangeHighlights), r("scale", a.scale, "linear"), r("focus", a.focus), l("min", a.min, 0), l("max", a.max, 10), l("step", a.step, 1);
                    var f = p.step + "", g = f.search(/[^.,]*$/), m = f.substring(g);
                    if (l("precision", i.precision, m.length), c("tooltip_split", i.tooltipsplit, !1), c("enabled", i.enabled, !0), c("naturalarrowkeys", i.naturalarrowkeys, !1), c("reversed", i.reversed, !1), c("range", a.range, !1), p.range) {
                    ...
                    i.formatter && (p.formatter = function (t) {
                    ...
                    n[0].__slider = b;
                    var y = d(i.updateevent);
                    y = angular.isString(y) ? [y] : ["slide"], angular.forEach(y, function (t) {
                        b.on(t, function (t) {
                            o.$setViewValue(t)
                        })
                    }), b.on("change", function (t) {
                        o.$setViewValue(t.newValue)
                    });
                    var D = {slideStart: "onStartSlide", slide: "onSlide", slideStop: "onStopSlide"};
                    return angular.forEach(D, function (t, n) {
                        var o = e(i[t]);
                        b.on(n, function (e) {
                            a[t] && a.$apply(function () {
                                o(a.$parent, {$event: e, value: e})
                            })
                        })
    ...
    var e = function () {
        ...
        return e.prototype.count = function (e, a, n, i, o, r, l, s) {
            var u = {};
            $(e).stop(!0, !0), e[a] = parseFloat(n || 0), u[a] = parseFloat(i || 0), e[a] != u[a] && $(e).animate(u, {
                duration: o,
                easing: r,
                step: l
        ...
        return e.prototype.$inject = ["$counter", "$timeout"], e.prototype.link = function (e, a, n, i) {
            var o = {effect: "linear", duration: 1e3};
            t.forEach(o, function (a, n) {
                t.isDefined(e[n]) || (e[n] = o[n])
            }), e.step = function (t) {
                $timeout(function () {
                    e.$apply(function () {
                        e.value = t
...
>>>>>>> 68d7bbfdab3ae8c80f526a3b9cd86bf7f73c596e
